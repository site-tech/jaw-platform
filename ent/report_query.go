...
func (rq *ReportQuery) GroupBy(field string, fields ...string) *ReportGroupBy {
	grbuild := &ReportGroupBy{config: rq.config}
...
func (rq *ReportQuery) Select(fields ...string) *ReportSelect {
	...
	selbuild := &ReportSelect{ReportQuery: rq}
	selbuild.label = report.Label
...
func (rq *ReportQuery) sqlExist(ctx context.Context) (bool, error) {
...
func (rgb *ReportGroupBy) sqlScan(ctx context.Context, v any) error {
...
func (rgb *ReportGroupBy) sqlQuery() *sql.Selector {
...
func (rs *ReportSelect) Scan(ctx context.Context, v any) error {
	...
	rs.sql = rs.ReportQuery.sqlQuery(ctx)
	return rs.sqlScan(ctx, v)
}

func (rs *ReportSelect) sqlScan(ctx context.Context, v any) error {
